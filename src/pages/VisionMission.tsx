      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 mt-24">
          <div className="space-y-10">
            ...
            <p className="text-2xl md:text-[2rem] text-ink/72 leading-[1.8] font-serif italic max-w-[20ch]">
          ...
          <div className="space-y-10">
            ...
            <p className="text-xl md:text-[1.9rem] text-ink/72 leading-[1.8] font-light max-w-[22ch]">
